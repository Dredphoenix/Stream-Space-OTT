...
import <ReactPlayer></ReactPlayer>
...
export default function MoviePage() {
  ...
  useEffect(() => {
    async function fetchMovie() {
      ...
      const simRes = await fetch(`https://api.themoviedb.org/3/movie/${id}/similar?api_key=${API_KEY}`);
      ...
      <div className="relative w-full h-[70vh] bg-black">
        ...
        <div className="absolute bottom-0 p-8 bg-gradient-to-t from-black to-transparent w-full">
          ...
          <div className="mt-4 flex gap-3">
            <button className="bg-red-600 hover:bg-red-700 px-4 py-2 rounded-lg font-semibold">Watch Now</button>
            <button className="bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-lg">+ Watchlist</button>
          </div>
        </div>
      </div>
